...
# depAnalysis/Makefile.  Generated from Makefile.in by configure.
...
##am__append_7 = -Wl,-z,noexecstack
noinst_PROGRAMS = depAnalysis-amd64-linux$(EXEEXT) \
	$(am__EXEEXT_1)
#am__append_8 = depAnalysis--linux
depAnalysis__linux_DEPENDENCIES =
subdir = depAnalysis
...
#am__EXEEXT_1 = depAnalysis--linux$(EXEEXT)
PROGRAMS = $(noinst_PROGRAMS)
am__objects_1 =  \
	depAnalysis_amd64_linux-da_main.$(OBJEXT)
am_depAnalysis_amd64_linux_OBJECTS =  \
	$(am__objects_1)
depAnalysis_amd64_linux_OBJECTS =  \
	$(am_depAnalysis_amd64_linux_OBJECTS)
am__depAnalysis__linux_SOURCES_DIST =  \
	da_main.c
am__objects_2 =  \
	depAnalysis__linux-da_main.$(OBJEXT)
#am_depAnalysis__linux_OBJECTS =  \
#	$(am__objects_2)
depAnalysis__linux_OBJECTS =  \
	$(am_depAnalysis__linux_OBJECTS)
AM_V_P = $(am__v_P_$(V))
...
am__depfiles_remade = ./$(DEPDIR)/depAnalysis_amd64_linux-da_main.Po \
	./$(DEPDIR)/depAnalysis__linux-da_main.Po
am__mv = mv -f
AM_V_lt = $(am__v_lt_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(depAnalysis_amd64_linux_SOURCES) \
	$(depAnalysis__linux_SOURCES)
DIST_SOURCES = $(depAnalysis_amd64_linux_SOURCES) \
	$(am__depAnalysis__linux_SOURCES_DIST)
...
am__relativize = \
  ...
  reldir="$$dir2"
ACLOCAL = ${SHELL} /home/junyangshao/Desktop/playground/cs510-lab1/valgrind/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/junyangshao/Desktop/playground/cs510-lab1/valgrind/missing autoconf
AUTOHEADER = ${SHELL} /home/junyangshao/Desktop/playground/cs510-lab1/valgrind/missing autoheader
AUTOMAKE = ${SHELL} /home/junyangshao/Desktop/playground/cs510-lab1/valgrind/missing automake-1.16
AWK = mawk
BOOST_CFLAGS = 
BOOST_LIBS = 
CC = gcc
...
LTO_RANLIB = ranlib
MAINT = #
MAKEINFO = ${SHELL} /home/junyangshao/Desktop/playground/cs510-lab1/valgrind/missing makeinfo
...
PACKAGE_STRING = Valgrind 3.19.0.GIT
PACKAGE_TARNAME = valgrind
PACKAGE_URL = 
PACKAGE_VERSION = 3.19.0.GIT
PATH_SEPARATOR = :
PERL = /usr/bin/perl
...
XCODE_DIR = 
XCRUN = 
abs_builddir = /home/junyangshao/Desktop/playground/cs510-lab1/valgrind/depAnalysis
abs_srcdir = /home/junyangshao/Desktop/playground/cs510-lab1/valgrind/depAnalysis
abs_top_builddir = /home/junyangshao/Desktop/playground/cs510-lab1/valgrind
abs_top_srcdir = /home/junyangshao/Desktop/playground/cs510-lab1/valgrind
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/junyangshao/Desktop/playground/cs510-lab1/valgrind/install-sh
...
pdfdir = ${docdir}
prefix = /home/junyangshao/Desktop/playground/cs510-lab1/valgrind/inst
...
depAnalysis_amd64_linux_SOURCES = \
	$(NONE_SOURCES_COMMON)

depAnalysis_amd64_linux_CPPFLAGS = \
	$(AM_CPPFLAGS_AMD64_LINUX)

depAnalysis_amd64_linux_CFLAGS = $(LTO_CFLAGS) \
	$(AM_CFLAGS_AMD64_LINUX)

depAnalysis_amd64_linux_DEPENDENCIES = \
	$(TOOL_DEPENDENCIES_AMD64_LINUX)

depAnalysis_amd64_linux_LDADD = \
	$(TOOL_LDADD_AMD64_LINUX)

depAnalysis_amd64_linux_LDFLAGS = \
	$(TOOL_LDFLAGS_AMD64_LINUX)

depAnalysis_amd64_linux_LINK = \
	$(top_builddir)/coregrind/link_tool_exe_linux \
	0x58000000 \
	$(LINK) \
	$(depAnalysis_amd64_linux_CFLAGS) \
	$(depAnalysis_amd64_linux_LDFLAGS)

#depAnalysis__linux_SOURCES = \
#	$(NONE_SOURCES_COMMON)

#depAnalysis__linux_CPPFLAGS = \
#	$(AM_CPPFLAGS_)

#depAnalysis__linux_CFLAGS = $(LTO_CFLAGS) \
#	$(AM_CFLAGS_)

#depAnalysis__linux_DEPENDENCIES = \
#	$(TOOL_DEPENDENCIES_)

#depAnalysis__linux_LDADD = \
#	$(TOOL_LDADD_)

#depAnalysis__linux_LDFLAGS = \
#	$(TOOL_LDFLAGS_)

#depAnalysis__linux_LINK = \
#	$(top_builddir)/coregrind/link_tool_exe_linux \
#	0xUNSET \
#	$(LINK) \
#	$(depAnalysis__linux_CFLAGS) \
#	$(depAnalysis__linux_LDFLAGS)
...
$(srcdir)/Makefile.in: # $(srcdir)/Makefile.am $(top_srcdir)/Makefile.tool.am $(top_srcdir)/Makefile.all.am $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign depAnalysis/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign depAnalysis/Makefile
...
depAnalysis-amd64-linux$(EXEEXT): $(depAnalysis_amd64_linux_OBJECTS) $(depAnalysis_amd64_linux_DEPENDENCIES) $(EXTRA_depAnalysis_amd64_linux_DEPENDENCIES) 
	@rm -f depAnalysis-amd64-linux$(EXEEXT)
	$(AM_V_GEN)$(depAnalysis_amd64_linux_LINK) $(depAnalysis_amd64_linux_OBJECTS) $(depAnalysis_amd64_linux_LDADD) $(LIBS)

depAnalysis--linux$(EXEEXT): $(depAnalysis__linux_OBJECTS) $(depAnalysis__linux_DEPENDENCIES) $(EXTRA_depAnalysis__linux_DEPENDENCIES) 
	@rm -f depAnalysis--linux$(EXEEXT)
	$(AM_V_GEN)$(depAnalysis__linux_LINK) $(depAnalysis__linux_OBJECTS) $(depAnalysis__linux_LDADD) $(LIBS)
...
include ./$(DEPDIR)/depAnalysis_amd64_linux-da_main.Po # am--include-marker
include ./$(DEPDIR)/depAnalysis__linux-da_main.Po # am--include-marker
...
depAnalysis_amd64_linux-da_main.o: da_main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(depAnalysis_amd64_linux_CPPFLAGS) $(CPPFLAGS) $(depAnalysis_amd64_linux_CFLAGS) $(CFLAGS) -MT depAnalysis_amd64_linux-da_main.o -MD -MP -MF $(DEPDIR)/depAnalysis_amd64_linux-da_main.Tpo -c -o depAnalysis_amd64_linux-da_main.o `test -f 'da_main.c' || echo '$(srcdir)/'`da_main.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/depAnalysis_amd64_linux-da_main.Tpo $(DEPDIR)/depAnalysis_amd64_linux-da_main.Po
#	$(AM_V_CC)source='da_main.c' object='depAnalysis_amd64_linux-da_main.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(depAnalysis_amd64_linux_CPPFLAGS) $(CPPFLAGS) $(depAnalysis_amd64_linux_CFLAGS) $(CFLAGS) -c -o depAnalysis_amd64_linux-da_main.o `test -f 'da_main.c' || echo '$(srcdir)/'`da_main.c

depAnalysis_amd64_linux-da_main.obj: da_main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(depAnalysis_amd64_linux_CPPFLAGS) $(CPPFLAGS) $(depAnalysis_amd64_linux_CFLAGS) $(CFLAGS) -MT depAnalysis_amd64_linux-da_main.obj -MD -MP -MF $(DEPDIR)/depAnalysis_amd64_linux-da_main.Tpo -c -o depAnalysis_amd64_linux-da_main.obj `if test -f 'da_main.c'; then $(CYGPATH_W) 'da_main.c'; else $(CYGPATH_W) '$(srcdir)/da_main.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/depAnalysis_amd64_linux-da_main.Tpo $(DEPDIR)/depAnalysis_amd64_linux-da_main.Po
#	$(AM_V_CC)source='da_main.c' object='depAnalysis_amd64_linux-da_main.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(depAnalysis_amd64_linux_CPPFLAGS) $(CPPFLAGS) $(depAnalysis_amd64_linux_CFLAGS) $(CFLAGS) -c -o depAnalysis_amd64_linux-da_main.obj `if test -f 'da_main.c'; then $(CYGPATH_W) 'da_main.c'; else $(CYGPATH_W) '$(srcdir)/da_main.c'; fi`

depAnalysis__linux-da_main.o: da_main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(depAnalysis__linux_CPPFLAGS) $(CPPFLAGS) $(depAnalysis__linux_CFLAGS) $(CFLAGS) -MT depAnalysis__linux-da_main.o -MD -MP -MF $(DEPDIR)/depAnalysis__linux-da_main.Tpo -c -o depAnalysis__linux-da_main.o `test -f 'da_main.c' || echo '$(srcdir)/'`da_main.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/depAnalysis__linux-da_main.Tpo $(DEPDIR)/depAnalysis__linux-da_main.Po
#	$(AM_V_CC)source='da_main.c' object='depAnalysis__linux-da_main.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(depAnalysis__linux_CPPFLAGS) $(CPPFLAGS) $(depAnalysis__linux_CFLAGS) $(CFLAGS) -c -o depAnalysis__linux-da_main.o `test -f 'da_main.c' || echo '$(srcdir)/'`da_main.c

depAnalysis__linux-da_main.obj: da_main.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(depAnalysis__linux_CPPFLAGS) $(CPPFLAGS) $(depAnalysis__linux_CFLAGS) $(CFLAGS) -MT depAnalysis__linux-da_main.obj -MD -MP -MF $(DEPDIR)/depAnalysis__linux-da_main.Tpo -c -o depAnalysis__linux-da_main.obj `if test -f 'da_main.c'; then $(CYGPATH_W) 'da_main.c'; else $(CYGPATH_W) '$(srcdir)/da_main.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/depAnalysis__linux-da_main.Tpo $(DEPDIR)/depAnalysis__linux-da_main.Po
#	$(AM_V_CC)source='da_main.c' object='depAnalysis__linux-da_main.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(depAnalysis__linux_CPPFLAGS) $(CPPFLAGS) $(depAnalysis__linux_CFLAGS) $(CFLAGS) -c -o depAnalysis__linux-da_main.obj `if test -f 'da_main.c'; then $(CYGPATH_W) 'da_main.c'; else $(CYGPATH_W) '$(srcdir)/da_main.c'; fi`
...
distclean: distclean-recursive
		-rm -f ./$(DEPDIR)/depAnalysis_amd64_linux-da_main.Po
	-rm -f ./$(DEPDIR)/depAnalysis__linux-da_main.Po
	-rm -f Makefile
